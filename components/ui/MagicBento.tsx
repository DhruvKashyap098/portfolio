            ...
            if (enableStars) {
              return (
                ...
                >
                  {cardBlurImage && (
                    <div
                      className="absolute inset-0 z-0 bg-center bg-cover blur-[1px]"
                      style={{ backgroundImage: `url(${cardBlurImage})` }}
                    />
                  )}
                  <div className="relative z-10 card__header flex justify-between gap-3 relative text-white">
                    <span className="card__label text-base">{card.label}</span>
                  </div>
                  <div className="relative z-10 card__content flex flex-col relative text-white">
